<script lang="ts">
	...
	function validate_form() {
		...
		if (whitespaces.test(firstname)) {
			warning = get(_)("login.warn.firstname_must_not_be_empty");
			return false;
		}
		if (whitespaces.test(lastname)) {
			warning = get(_)("login.warn.lastname_must_not_be_empty");
			return false;
		}
		return true;
	}
